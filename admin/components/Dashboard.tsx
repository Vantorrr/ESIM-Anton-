...
export default function Dashboard() {
  ...
  const statsCards = [
    ...
    },
    {
      ...
      change: `${displayStats.orders.completed} выполнено`,
      icon: Package,
    ...
    },
    {
      ...
      change: `Средний чек: ₽${displayStats.revenue.average.toFixed(0)}`,
      icon: CreditCard,
      color: 'from-green-500 to-emerald-500',
    },
    {
      title: 'Конверсия',
      value: `${displayStats.orders.conversionRate.toFixed(1)}%`,
