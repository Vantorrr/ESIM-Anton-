...
const NAME_TO_ISO: Record<string, string> = {
  ...
  'chile':'CL','china':'CN','colombia':'CO','comoros':'KM',  'congo':'CG','democratic republic of the congo':'CD','dr congo':'CD',
...
const PROVIDER_CODE_NAMES: Record<string, string> = {
  ...
  'AF-29': 'Африка',
  // Asia
  'AS-5': 'Центральная и Южная Азия',
  'AS-7': 'Юго-Восточная Азия',
  'AS-12': 'Азия',
  'AS-20': 'Азиатско-Тихоокеанский',
  'AS-21': 'Азия расширенная',
  // British Isles
  ...
  // Global
  'GL-120': 'Глобальный 120+ стран',
  'GL-139': 'Глобальный 139 стран',
  // Middle East
